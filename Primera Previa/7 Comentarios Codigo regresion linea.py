...
# En la función poly1d genera las diferentes variables elevadas a sus distintas potencias para luego ser acompañadas con los coefiecientes #generados anteriormente 
f1 = sp.poly1d(fp1)
#En la función polyfit se crea un listado con los coeficientes del polinomio de orden n en este caso de grado 2 
...
#En la función polyfit se crea un listado con los coeficientes del polinomio de orden n  en este caso  de grado 10
f10 = sp.poly1d(np.polyfit(x, y, 10))
#En la función polyfit se crea un listado con los coeficientes del polinomio de orden n  en este caso  de grado 100
f100 = sp.poly1d(np.polyfit(x, y, 100))

# Se grafican los modelos
# -----------------------------------------------------------------
#Crea los tres archivos de imagen y guarda en ellos los gráficos concernientes a las diferentes funciones polinomiales, luego los ubica en 
#la carpeta charts todo esto haciendo uso de la función implementada en el archivo utility 
...
#Acorde a las gráficas definimos un punto de inflexión y con dicho punto se obtiene el error de las gráficas comparandolas con la proximidad a #dicho punto para facilitar la elección de la gráfica que se usará para la predicción
...
# Se toman las gráficas y se extienden hasta el punto máximo que está ubicado más allá lo que indican los datos con el fin de obtener una #predicción de los futuros datos
# -----------------------------------------------------------------
plot_models(
